...
<br>
<br>
<form id="demo" class="rating" method="POST" action="/setrating/{{$user->id}}" style="padding-left: 250px;">
  {{ csrf_field() }}
...
<form method="GET" action="/placeappointments/{{$user->id}}" style="padding-left: 250px;">
      {{ csrf_field() }}
